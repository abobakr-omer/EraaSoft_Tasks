...
<body class="dashboard-body">
    ...
    <main class="page-container">
        <section class="card operation-card">
            <div class="operation-symbol deposit-symbol">+</div>
            <h1>Deposit money</h1>
            <p class="subtitle">Enter the amount you want to add to your wallet.</p>
            ...
            <form method="post" action="${pageContext.request.contextPath}/WalletController">
                ...
                <button class="button primary" type="submit">Confirm deposit</button>
            </form>
        </section>
    </main>
</body>
